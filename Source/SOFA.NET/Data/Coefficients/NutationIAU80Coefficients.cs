...
internal readonly struct NutationIAU80Coefficients
{
    public readonly int nl, nlp, nf, nd, nom;
    public readonly double sp, spt,
        ce, cet;

    public NutationIAU80Coefficients(int nl, int nlp, int nf, int nd, int nom, double sp, double spt, double ce, double cet)
        => (this.nl, this.nlp, this.nf, this.nd, this.nom, this.sp, this.spt, this.ce, this.cet) = (nl, nlp, nf, nd, nom, sp, spt, ce, cet);

    private static NutationIAU80Coefficients[]? coefficients;

    public static NutationIAU80Coefficients[] Coefficients
    {
        get
        {
            if (coefficients == null)
            {
                coefficients = InitializeCoefficents();
            }
    ...
    private static NutationIAU80Coefficients[] InitializeCoefficents()
    {
        return new NutationIAU80Coefficients[]
        {
            /* 1-10 */
